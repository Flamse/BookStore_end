...
public class dao_Order {
	...
	public void add(Order order) throws SQLException{
		...
		//完善Order表
		String sql="insert into orders(id,state,ordertime,totalprice,user_id) values(?,?,?,?,?)";		//下单失败的底层问题
		...
		for(Entry<String, OrderItem> entry:order.getMap().entrySet()){
			sql="insert into orderItem(id,price,num,sum,orders_id,book_id) values(?,?,?,?,?,?)";		//紧接着第二个问题
