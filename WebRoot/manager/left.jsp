...
<body style="text-align: center;">
	...
	<ul>
		...
		<li>
			<!-- <a href="#"  target="body">图书管理</a> -->图书管理
			<a href="${pageContext.request.contextPath }/manager/BookServlet?method=addBookUI"  target="body">添加图书</a><br>
			<a href="${pageContext.request.contextPath }/manager/BookServlet?method=listAllBook"  target="body">查看图书</a>
			<br><br>
		</li>
		<li>
			<!-- <a href="#"  target="body">订单管理</a> -->订单管理
